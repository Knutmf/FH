...
<h1>The Forgotten Heralds</h1>

<p>The Forgotten Heralds (FH) is a cadre of action and results-oriented professionals who accept significant, demanding responsibilities and accountability for results.</p>

<iframe
	src="https://www.youtube.com/embed/CjyJLGXSYhI" 
...
<p><span className="text-dates-mainpage">2681</span> : The Vanduul, a nomadic leeward race in the west, starts raiding our new settlements in the Tevarin systems and disappearing. They seemingly have no homeworld; each Vanduul clan is a roaming fleet, making them exceedingly hard to catch.<br /><br /></p>

<p><span className="text-dates-mainpage">2715-2788</span> : The military regime reaches a plateau. While the human populace has been somewhat beaten into submission, there’s a current of subversion in the culture. People are starting to see the cracks in the system. Activist groups launch attacks against the political/propaganda machine. The military is stretched thin, bracing for war with Xi’An, chasing down Vanduul raiders, and trying to maintain security on the human systems. The Imperator’s power is waning.<br /><br /></p>

<p><span className="text-dates-mainpage">2920</span> : The Vanduul attacks are growing in frequency and the UEE is perceived to be doing nothing about it. After more than a century of steadily shrinking military expenditures due in large part to a combination of fear and disillusionment toward the UEE government’s post-Messer era war machine.<br /><br /></p>

<p><span className="text-dates-mainpage">2945</span> : The Vanduul attack the Vega system in full force, destroying the blockade around the Vega side of the jump point. Vanduul forces do battle over, and make planetfall on Vega II. The system is saved from occupation due in largest part to the tmely arrival of Admiral Bishop’s fleet from its location: a jump point away.<br /><br /></p>

<iframe 
	src="https://www.youtube.com/embed/izdRLkV4-FU" 
	title="YouTube video player" >
</iframe>

<h1>What is it that drives you?</h1>

<p>In the vast expanses of time and space what singular moment defines you? …That first moment when you tasted the air of a world other than your own? When you climbed into your father’s lap and got your first real glimpse of what it meant to fly? Or was it the first time you heard about some new discovery or innovation? Individually; we’ve all had our imaginations captured by something. For my part – for our part; that singular, shining, bleeding moment …that defining clarion that set us upon our true path was Aremis …was Vega 2.</p>


<h1>For us - The founding Members</h1>
<p>For us – the founding members; that was where things truly began. On October 5th, 2945; the Vanduul ran the blockade and started laying waste the Vega side of the jump point: We were more ready than I think the Vanduul expected, but in the chaos of that conflict; every military axiom imaginable came to life: friendly fire …isn’t, Foxholes make fast friends, no plan survives contact with the enemy, there are no Atheists in the trenches, and so on. Men, women, and children suffered and died, bringing to life all of the horror stories such invasions always have throughout Earth’s history. It also saw shining examples of bravery, creativity, stalwartness, and raw will. The best and worst in aching harmony.</p>

<p>Colonel Crandal’s forces held the line until Admiral Bishop arrived, and while every passing moment saw more ground taken by the vanduul, we made them bleed for it.
